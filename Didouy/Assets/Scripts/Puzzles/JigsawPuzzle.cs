...
public class JigsawPuzzle : MonoBehaviour
{
    ...
    void Update()
    {
        // If all of the button have their rotation on z axis as 0, then puzzle is complete.
        // If the raycast from player detects a portrait collider 2, after it is complete it will
        // Destroy the object and set eye active.
        if (FramePuzzle != null)
        {
